...
// Check if a specific test was selected
                ...
                <table class="table table-striped">
                    <thead class="thead-dark">
                        <tr class="bg-warning">
                            ...
                            <th scope="col">Right Questions</th>
                            <th scope="col">Wrong Questions</th>
                            <th scope="col">Not Attempted</th>
                            <th scope="col">Max Marks</th>
                            <th scope="col">Marks Obtained</th>
                            <th scope="col">Percentage</th>
                            <th scope="col">Award for Wrong</th>
                            <th scope="col">Award for Right</th>
                    ...
                    <tbody>
                        ...
                        <tr class="table-light">
                            ...
                            <td><?php echo htmlspecialchars($score['award_for_wrong']); ?></td>
                            <td><?php echo htmlspecialchars($score['award_for_right']); ?></td>
                            <td>
